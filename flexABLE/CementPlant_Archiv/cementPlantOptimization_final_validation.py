...
def cementOptBase(
    ...
    if TPrevious == 0:
        ...
        print('Production goal: ', productionGoal)
        print('production goal previous section: ', sum(previousSection['output_cement_mill']))
    # timesteps
    ...
    def cement_mill_start_rule_3(model, t):
        if t <= TPrevious:
            return model.cement_mill_start[t] == previousSection['cement_mill_start'][t-1]
        else:
   ...
   # log_infeasible_constraints(model)
    ...
    print("slag: ", sum(results_df["slag"]))
